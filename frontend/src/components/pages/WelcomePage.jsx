            ...
            <main className="relative pt-32 pb-10 px-6 z-10">
                ...
                <div className="max-w-7xl mx-auto text-center mb-24">
                    ...
                    <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-12 leading-relaxed">
                        Chinh phục thử thách, leo bảng xếp hạng và khẳng định vị thế của bạn.
                    </p>
                ...
                <div className="max-w-7xl mx-auto space-y-16 md:space-y-24">
                    <div className="text-center mb-12">
                        <h2 className="text-4xl md:text-5xl font-black mb-4 text-gray-900 dark:text-white">Featured Games</h2>
                            ...
                            >
                                        ...
                                        <div className="aspect-[16/10]">
                                             <img 
                                                ...
                                                onError={(e) => {
                                                    ...
                                                    e.target.src = "https://images.unsplash.com/photo-1511512578047-dfb367046420?q=80&w=2671&auto=format&fit=crop";
                                                }}
                                             />
                                        </div>
                                    </div>
                                    {/* Decorative Blob - Hidden in Light Mode */}
                                    <div className={`absolute -z-10 -top-10 -left-10 w-full h-full bg-gradient-to-r ${isEven ? 'from-purple-500/10 to-pink-500/10' : 'from-indigo-500/10 to-blue-500/10'} rounded-3xl blur-3xl transform scale-110 opacity-0 dark:opacity-40 transition-opacity`}></div>
                                </div>
                                ...
                                <div className="flex-1 space-y-6 text-center md:text-left">
                                    ...
                                    <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                                        {game.description || 'Trải nghiệm đỉnh cao. Thử thách bản thân và tranh tài cùng bạn bè.'}
                                    </p>

                                    {/* Features */}
                                    <div className="space-y-3 pt-2">
                                        {(config.howToPlay || ["Challenge friends", "Global leaderboard"]).slice(0, 3).map((feature, i) => (
                                            <div key={i} className={`flex items-center gap-3 text-gray-700 dark:text-gray-400 justify-center md:justify-start`}>
