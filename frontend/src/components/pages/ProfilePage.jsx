import { Mail, MapPin, Calendar, Edit2, Github, Linkedin, Twitter, Trophy, Zap, Star, Crown, Flame, Medal, TrendingUp, Gamepad2 } from 'lucide-react';
    ...
    return (
        <div className="space-y-6 animate-fadeIn">
            ...
            <div>
                ...
                <p className="text-muted-foreground">Manage your profile, friends, and achievements</p>
            </div>
                                    ...
                                    return (
                                        ...
                                        >
                                            <CardContent className="p-4">
                                                ...
                                                <p className="text-sm text-center mb-1 font-medium">{achievement.name}</p>
                                                <div className="flex justify-center">
                                                    <Badge variant="secondary" className="text-xs">{achievement.rarity}</Badge>
                                                </div>
                                                ...
                                                <div className="absolute inset-x-0 -top-20 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">
                                                    <Card className="mx-auto max-w-fit">
                                                        <CardContent className="p-3 text-center">
                                                            <p className="text-xs mb-1 font-medium">{achievement.name}</p>
