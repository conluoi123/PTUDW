...
import { Mail, Lock, Eye, EyeOff, Gamepad2, Zap, Shield, ArrowLeft } from 'lucide-react';
            ...
            <div className="relative z-10 w-full max-w-md animate-in fade-in zoom-in duration-500">
                <div className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-xl rounded-3xl p-8 sm:p-10 border border-gray-700/50 shadow-2xl">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-400 text-sm sm:text-base">Login to continue your gaming journey</p>
                    </div>
                    ...
                    <div className="relative mb-6">
                        ...
                        <div className="relative flex justify-center text-xs">
                            <span className="bg-card/80 px-3 py-1 rounded-full text-gray-400 font-medium">Or continue with email</span>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    className={`pl-11 pr-4 h-12 bg-input border-border focus-visible:border-cyan-500 focus-visible:ring-cyan-500/20 ${errors.email ? 'border-red-500 focus-visible:border-red-500' : ''
                                        }`}
                                />
                            </div>
                            {errors.email && (
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    className={`pl-11 pr-12 h-12 bg-input border-border focus-visible:border-cyan-500 focus-visible:ring-cyan-500/20 ${errors.password ? 'border-red-500 focus-visible:border-red-500' : ''
                                        }`}
                                />
                                <button
                                    type="button"
                        ...
                        <div className="flex items-center justify-between text-sm">
                            <label className="flex items-center gap-2 cursor-pointer group">
                                <input type="checkbox" className="w-4 h-4 rounded border-border bg-input text-cyan-500 focus:ring-cyan-500/20" />
