...
import { Mail, Lock, Eye, EyeOff, User, Gamepad2, Shield, Zap, ArrowLeft } from 'lucide-react';
            ...
            <div className="relative z-10 w-full max-w-md animate-in fade-in zoom-in duration-500">
                <div className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-xl rounded-3xl p-8 sm:p-10 border border-gray-700/50 shadow-2xl">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-400 text-sm sm:text-base">Create your account and start playing</p>
                    </div>
                    ...
                    <div className="relative mb-6">
                        ...
                        <div className="relative flex justify-center text-xs">
                            <span className="bg-card/80 px-3 py-1 rounded-full text-gray-400 font-medium">Or register with email</span>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    className={`pl-11 pr-4 h-11 bg-input border-border focus-visible:border-purple-500 focus-visible:ring-purple-500/20 ${errors.name ? 'border-red-500 focus-visible:border-red-500' : ''
                                        }`}
                                />
                            </div>
                            {errors.name && (
                                <p className="text-red-400 text-xs mt-1.5 animate-in slide-in-from-top duration-200">{errors.name}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    className={`pl-11 pr-4 h-11 bg-input border-border focus-visible:border-purple-500 focus-visible:ring-purple-500/20 ${errors.email ? 'border-red-500 focus-visible:border-red-500' : ''
                                        }`}
                                />
                            </div>
                            {errors.email && (
                                <p className="text-red-400 text-xs mt-1.5 animate-in slide-in-from-top duration-200">{errors.email}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    className={`pl-11 pr-12 h-11 bg-input border-border focus-visible:border-purple-500 focus-visible:ring-purple-500/20 ${errors.password ? 'border-red-500 focus-visible:border-red-500' : ''
                                        }`}
                                />
                                <button
                                    type="button"
                            ...
                            {errors.password && (
                                <p className="text-red-400 text-xs mt-1.5 animate-in slide-in-from-top duration-200">{errors.password}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    className={`pl-11 pr-12 h-11 bg-input border-border focus-visible:border-purple-500 focus-visible:ring-purple-500/20 ${errors.confirmPassword ? 'border-red-500 focus-visible:border-red-500' : ''
                                        }`}
                                />
                                <button
                                    type="button"
                            ...
                            {errors.confirmPassword && (
                                <p className="text-red-400 text-xs mt-1.5 animate-in slide-in-from-top duration-200">{errors.confirmPassword}</p>
                            )}
                        </div>
                        ...
                        <div>
                            <label className="flex items-start gap-3 cursor-pointer group">
                                ...
                                <span className="text-sm text-gray-400 group-hover:text-gray-300 transition-colors">
                                    I agree to the{' '}
                                    <button type="button" className="text-purple-400 hover:text-purple-300 font-medium">Terms of Service</button>
                                    {' '}and{' '}
                                    <button type="button" className="text-purple-400 hover:text-purple-300 font-medium">Privacy Policy</button>
                                </span>
                            </label>
                            {errors.terms && (
                                <p className="text-red-400 text-xs mt-1.5 animate-in slide-in-from-top duration-200">{errors.terms}</p>
                            )}
                        </div>
